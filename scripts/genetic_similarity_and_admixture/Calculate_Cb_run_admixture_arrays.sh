...
admixture --cv=10 -s "$current_seed" "../../processed_data/Cb_pruned_VCF_and_PCA/EIGESTRAT/LD_0.9/INPUTFILES/eigenstrat_input.ped" $current_pop -j24 | tee "log_${current_pop}_${current_seed}.out"
# The .ped file was generated by post-gatk-nf pipeline
