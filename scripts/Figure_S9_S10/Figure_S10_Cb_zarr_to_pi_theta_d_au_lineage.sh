...
#SBATCH -N 1
#SBATCH -n 2
#SBATCH --output=Cb_zarr_to_pi_theta_d_au_lineage.oe
#SBATCH --job-name="CbZ2PitdAuLineage"
...
mkdir -p Australia_lineage
cd Australia_lineage


#Define the inputs and outputs
out_dir="$HOME/vast-eande106/projects/Bowen/Nikita_PopGen_Brig_Project/2025_PopGen_Bri/processed_data/pi_theta_d_by_lineage/Australia_lineage"
...
zarr="$HOME/vast-eande106/projects/Bowen/Nikita_PopGen_Brig_Project/2025_PopGen_Bri/processed_data/pi_theta_d_by_lineage/Australia_lineage/vcf_and_zarr"
