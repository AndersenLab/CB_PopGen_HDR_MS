...
tracy_for_plot <- data.table::fread("../../processed_data/PCA_all/EIGESTRAT/LD_0.9/NO_REMOVAL/TracyWidom_statistics_no_removal.tsv") %>%
...
cdf9no <- data.table::fread("../../processed_data/PCA_all/EIGESTRAT/LD_0.9/NO_REMOVAL/eigenstrat_no_removal.evac", skip = 1)
...
p_PC1_PC2
# ggsave("Cb_all_isotypes_PCA_plot_PC1_2_with_density.pdf", plot = p_PC1_PC2, width = 3.75, height = 3.75, units = "in")
...
p_PC3_PC4
# ggsave("Cb_all_isotypes_PCA_plot_PC3_4_with_density.pdf", plot = p_PC3_PC4, width = 3.75, height = 3.75, units = "in")
