...
thomas_paper_tree_annotation_raw<-read.table("../../data/Thomas_2015_tree_annotation/thomas_paper_tree_annotation.txt",
                                             header = TRUE)
...
gene_segments_trees_raw<-read_excel("../../data/Marie_anne_2013_and_Richard_2011_paper/all_strains_manually_generated.xlsx")
...
ggsave("../../figures/raw_SF7_Cb_tree.pdf",
